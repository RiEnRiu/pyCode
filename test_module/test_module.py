...
# it is a leaf node if node['sub_trees'] is a weight value not a list
...
def encode_poetry(n,k,c):
    ...
    # logn
    len_poetry, len_max_s = _encede_lenth(c), c['depth']
        
    return len_poetry,len_max_s
