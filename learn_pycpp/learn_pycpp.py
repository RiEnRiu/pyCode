...
g++ -shared -fPIC -std=c++11 -O3 ~/anaconda3/lib/libpython3.6m.a modify_order_by_weight.cpp  -o modify_order_by_weight.so -I~/anaconda3/include/python3.6m -lboost_python36
'''

'''
# third use .os in python
from modify_order_by_weight import *
'''
